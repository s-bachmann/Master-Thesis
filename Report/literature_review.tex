...
\end{equation} \parencite{afanasievModularFlexibleSpectralelement2019}. When the divergence theorem, which relates the flux of a vector field through a closed surface to the divergence of the field in an enclosed volume: $\ \iiint_V (\nabla \cdot F) dV = \oiint_s (F \cdot \hat{n}) dS $. 
