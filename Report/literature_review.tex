...
\begin{itemize}
  ...
  \end{equation}, of which the first terms can be substituted with the wavespeed using the wavenumber-frequency and velocity relationship from the Lamé parameters. 
