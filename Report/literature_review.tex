...
\begin{itemize}
  ...
  \end{equation}, which is the dispersion of the symmetric mode of the Lamb waves, as described by \cite{suFundamentalsAnalysisLamb2009}. The same can be done for the asymmetric Lamb wave mode if the operations of the stresses are opposite. 
