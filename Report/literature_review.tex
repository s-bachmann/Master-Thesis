...
\end{equation} \parencite{afanasievModularFlexibleSpectralelement2019}. The first integral on the left side of \ref{eq:second weak form} is the boundary integral, which changed depending on the boundary conditions implemented. 
