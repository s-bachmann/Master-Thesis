...
\begin{itemize}
  ...
  \end{equation} for S-waves, the wave speeds are derived from the Lamé-Parameters, as described in \ref{sec:czm methods}. All of this is done according to \cite{achenbachCHAPTER6WITHDRAWN1975}. \par
  ...
  \end{equation} \parencite{achenbachCHAPTER6WITHDRAWN1975}. \par


  At the snow-air interface, there is a stress-free boundary because of the impedance contrast. This means that both the normal and the shear stress need to be zero: \begin{equation}
