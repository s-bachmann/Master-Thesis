...
The model described in \ref{sec:czm methods} is implemented using the finite-element (FE) method in SALVUS. To discretize a domain, the domain is divided into a finite number of elements \parencite{FiniteElementMethod}
