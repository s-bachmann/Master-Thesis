...
\end{equation}, using the notations $\ (a,b)_G = \int_g a \cdot b d^nx, \langle a,b\rangle_{\delta_G} = \int_{\delta G}  a \cdot b d^{n-1}x$  as well as Hoek's law \parencite{afanasievModularFlexibleSpectralelement2019}. \par 
