...
\begin{description}
  ...
  \item[$r_{\rm mode}$]: Mode mix parameter [dimensionless].
  \item[$l_{cz}$]: Cohesive process (fracture) zone length [m].
  \item[$l_{ch}$]: Irwin characteristic length [m].
  \item[$\lambda_{\min}$]: Shortest wavelength to resolve [m].
