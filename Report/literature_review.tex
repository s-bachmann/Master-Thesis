...
\end{equation} \parencite{afanasievModularFlexibleSpectralelement2019}. In FE, an element-specific referency coordinate system $\ \theta$ is used. To transfrom the integrals and derivaties to physical coordinates x, the element-specific Jacobian $\ \frac{\delta x}{\delta \theta}$ is used \parencite{afanasievModularFlexibleSpectralelement2019}. Equations \ref{eq:galerkin displacement} and \ref{eq:weighted weak form} and their derivatives become: \begin{equation}
