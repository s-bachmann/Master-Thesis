...
\begin{itemize}
  ...
  \item Also show fk plots of all the case and discuss which speed dominates when (eg in sub-rayleigh it's the slab speed) \rightarrow possibly timoshenko effects here because of the 4th order term when frequency goes higher approximates medium speed ? 
  \item I would like to discuss the implications of the different wave types: eg have a clear, physical explaiantion for what different types of waves mean and how this is shown in terms of the crack or the snowpack
