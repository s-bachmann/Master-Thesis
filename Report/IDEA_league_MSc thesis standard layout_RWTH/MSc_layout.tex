...
% Acronyms
    ...
    %
    \begin{acronym}%
        \acro{DUT}{Delft University of Technology}%examples
...
% Bibliography
    ...
    \printbib{../master thesis.bib} % in MyBib.bib you add all your reference information, following the correct format.
