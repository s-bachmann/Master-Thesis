...
From the same vertex, in the vx plots at crack depth (bottom left in \ref{fig:mpm_vel}), fronts with weaker amplitude originate. These wavefronts fan out from around x=125m and they are layered in polarity (positive followed by negative). They also widen as time incerases, which could indicate geometric spreading. Such secondary wavefronts are not present in the vx plot at the snow bottom. \par 
...
The data used for the f-k plot is the vertical velocity data, for the reasons described in \ref{sec:results-1}. 
...
Additional to the energy concentrated around the p-wave speeds, 
