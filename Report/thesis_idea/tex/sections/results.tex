...
These weaker amplitude fronts broaden with increasing time, which is consistent with geometric spreading. Their amplitude does not decrease however. In the strain rate at crack depth (y=0.525m, weak layer, shown on top right of figure \ref{fig:mpm_strain}), the colors of the second wavefront are weaker than in the strain panel at the same depth. This means that they have lower amplitude relative to the main wavefront in the strain rate panel. \par
