...
Figure \ref{fig:preliminary_fk_lamb} shows the same frequency-wavenumber spectrum. The Lamb-wave dispersion curves obtained in section \ref{sec:wave_physics} are indicated by the orange (antisymmetric, A0) and the green line (symmetric, S0). These are plotted seperately because they fall close to the vp of the slab in both cases and the lines would not be very well recognizable. 
