...
The wavefronts arriving in all cases switch between polarities. While the pattern of opposite polarity is the same in all cases, the slope of the wavefronts change. In all plots, after the first wavefront, the waves seem to slow, which means their slope flattens. \par
