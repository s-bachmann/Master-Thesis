...
\begin{figure}[H]
    ...
    \caption{F-k plot for the Supershear (left) and sub-Rayleigh (right) case. Lamb wave dispersion curves calculated from \ref{sec:wave_physics}. A0 mode shown in orange, S0 mode in orange. Colorbar shows energy normalized to the 99th percentile.}
