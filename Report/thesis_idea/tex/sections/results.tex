...
\section{Cohesive Zone Model Results}

The results of the CZM model will not be discussed in detail. This is because the simple model results suffice to understand the MPM-aided model results. Additionally, if physics of the CZM model are kept simple, for example when there is no mode mix of the fracturing, the CZM results are very close to the simple model results. 
