...
The same two-layer medium as in section \ref{sec:czm_methods} was set up. This medium spans 400m in width and 3m in height.In the simple case, a series of SALVUS moment tensor sources are set up with a certain distance, they span from 30m to 270m with a spacing of 10cm. The time delay with which the sources fire is dependend on the sub-rayleigh or supershear case which is implemented, the bounds for the crack propagation velocity are taken from \cite{trottetTransitionSubRayleighAnticrack2022}, they are 0.6 or 1.6 times the shear wave velocity for sub-rayleigh and supershear cases respectively. The bedrock or soil is not considered in both models. This is because preliminary tests of a 3-layered medium have shown that it acts as a reflector of waves. For computational efficiency, the bedrock layer was thus neglected and the bottom of the snow was made a regular boundary,in other words, reflecting, to mimick the presence of a layer below the snow. 
