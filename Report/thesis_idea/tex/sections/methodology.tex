...
The theory in section \ref{sec:das_theory} is used to simulate DAS data from the outputs given by SALVUS. This is done by extracting the displacement output. The spatial derivative of displacement is taken to obtain strain, the temporal derivative of strain results in strain rate. 
