...
\end{equation} In the MPM case, the shape of the wavelets is obtained as described in \ref{sec:from_mpm_to_se}. The workflow of the code, including how the source speed is set up can be seen in the following flowchart. 
...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[node distance=1.5cm and 2.5cm, every node/.style={text centered}]
        ...
        \node (pro5) [process, right=of pro3] {Tapering of first and last sources to avoid injection noise};
