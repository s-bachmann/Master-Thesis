...
thesis and remains an open question for field validation, this also depends on the instrument used. An assesment for the Silixa iDAS system used by \cite{paitzPhenomenologyAvalancheRecordings2023} is done in section \ref{sec:DAS_noise}. This means that additional to the S0/P-wave precursor, which in some cases is weak in amplitude, there is an additional precursor in the quasi-static field, which could help in early warning of avalanche nucleation.  \par
