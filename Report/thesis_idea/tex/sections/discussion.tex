...
\subsubsection{Propagation speeds observed}
...
Backward propagating                   & $\ v_{prop} = \frac{75-0}{1-1.7} $      & 107 m/s          \\ \hline
Second wavefront                       & $\ v_{prop} = \frac{175-150}{4-3} $     & 25 m/s           \\ \hline
Forward propagating after crack arrest & $\ v_{prop} = \frac{200-125}{1.9-1.2} $ & 107 m/s          \\ \hline
\end{tabular}
