...
\subsection{F-k Plot}
The f-k plot confirms the structures which have been observed in the previous sections. The f-k spectrum of the MPM-guided simulation (figure \ref{fig:mpm_fk}) shows two pairs of symmetric energy bands, one on each side of the wavenumber axis.\par
...
lines in figure \ref{fig:preliminary_fk}, does not appear here. This is consistent with the shorter crack length in the MPM model (40m versus 240m in the simple model): a shorter source array produces less coherent beaming of A0 energy into a concentrated f-k ridge, spreading it instead into a diffuse background \parencite{roseWavesPlates2014}. This background could be contained in the concentration of energy around the two p-wave speeds. \par
