...
Supershear   & 1.6*vs = 108.7m/s & $ \ \frac{270-30m}{2.3s} = 104m/s$ \\ \hline
\end{tabular}
...
\item Slower waves could be rayleigh / surface waves along snow air interface? because they travel at 0.92vs, also seen in fk-plot, which has an unidentified concentration of energy
\item curved in the medium: dispersion 
\item has larger amplitude in vy than vx: eliptical motion of particles?
\item less amplitude decay: gemetric spreading is 1/sqrt r so less decay than body waves 
