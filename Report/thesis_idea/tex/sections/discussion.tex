...
The polarity reversal of the velocites in both sub-Rayleigh and Supershear case is caused by oscillatory waves. The presence of these wave types can be proven mathematically, the detailed derivation of this is shown in section \ref{sec:wave_physics}.
