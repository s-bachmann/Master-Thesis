...
\begin{frame}[allowframebreaks]{Words I will propably say a lot explained}
    \begin{itemize}
        ...
        \centering
    \includegraphics[width=0.6\linewidth]{../figures/fracture_modes.png}
    ...
    \item Sub-Rayleigh: Cracks that propagate at speeds lower than the shear wave speed in snow
    \item Supershear: Cracks propagate faster than shear wave speed in snow
    \end{itemize}
...
\begin{frame}{State of the art}
    \begin{itemize}
        \item Two camps: Crack opening vs anticrack 
    \end{itemize}
