...
\begin{frame}{Sub-Rayleigh vs Supershear}
    \begin{figure}
    \centering
    \includegraphics[width=\linewidth]{../figures/subrayleigh_vs_supershear_vy.png}
    \caption{Comparison of vertical particle velocity sub-Rayleigh and supershear cases}
    \end{figure}
    
\end{frame}

\begin{frame}{X and y space-time plots}
    \begin{figure}
        \centering
        \includegraphics[width=\linewidth]{../figures/vy_vx_supershear.png}
        \caption{Space-time plots of vertical and horizontal particle velocity for the supershear case}
    \end{figure}
...
\begin{frame}{WIggles}
    \begin{figure}
        \centering
        \includegraphics[width=\linewidth]{../figures/wiggle_plot_ss.png}
        \caption{Wiggle plot of vertical particle velocity for the supershear case}
    \end{figure}
...
\begin{frame}{STF}
    \begin{figure}
        \centering
        \includegraphics[width=0.3\linewidth]{../figures/stf_ss.png}
        \caption{Source-time function, PSD and single trace for the supershear case}
    \end{figure}
    
\end{frame}


\begin{frame}{New ToDos}
    \begin{itemize}
        \item Summary of crack types needs to be improved (I will send as soon as it's done)
    \end{itemize}
