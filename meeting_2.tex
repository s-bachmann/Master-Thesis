...
\begin{frame}{Single traces \& Spectrograms}
    \begin{figure}
        ...
        \begin{subfigure}[t]{0.49\textwidth}
            \centering
            \includegraphics[width=\textwidth]{figures/traces_spectrogram.png}     
            \caption{Single trace and spectrogram for vector point source.}
        \end{subfigure}
        \hfill
        \begin{subfigure}[t]{0.49\textwidth}
            \centering
            \includegraphics[width=\textwidth]{figures/traces_spectrogram_momentt.png}
            \caption{Single trace and spectrogram for moment tensor source.}
        \end{subfigure}
    \end{figure}
\end{frame}
